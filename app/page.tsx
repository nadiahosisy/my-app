  ...
  return (
    <div>
      <div className=" min-h-screen text-gold-100 h-screen bg-custom-pattern bg-cover bg-center">
        {/* Welcome Section */}
        <header className=" text-gold-900 py-16">
          <div className="container mx-auto text-center">
            ...
            <button className="btn-gold-500 text-gray-900 font-semibold py-2 px-6 rounded-full shadow-lg hover:bg-gold-400 transition duration-200">
              גלו את התפריט
            </button>
          </div>
        </header>
